...
function EditStudent(props) {
  const [student, setUser] = useState({ _id: '', studentNumber: '', firstName: '', lastName: '', 
  ...
  const updateStudent = (e) => {
    setShowLoading(true);
    e.preventDefault();
    const data = {  _id: student._id ,studentNumber: student.studentNumber, firstName: student.firstName, lastName: student.lastName, 
  ...
  return (
    <div>
      ...
      <Jumbotron>
        ...
        <Form.Group>
            <Form.Label> Stuent Number</Form.Label>
          ...
          <Form.Group>
            ...
            <Form.Control type="number" name="phoneNumber" id="phoneNumber" placeholder="Enter phone number" value={student.phoneNumber} onChange={onChange} />
          </Form.Group>
          <Form.Group>
