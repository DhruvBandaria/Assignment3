...
function ShowStudent(props) {
  ...
  const deleteStudent = (id) => {
    setShowLoading(true);
    const user = { studentNumber: data.studentNumber, firstName: data.firstName, lastName: data.lastName,
      address: data.address, city: data.city, phoneNumber: data.phoneNumber,
      email: data.email, program: data.program, password: data.password };
